...
export function createInitialStory(): StoryStructure {
  return {
    periods: [
      {
        id: 'detstvo',
        title: 'Детство',
        hint: 'Самые ранние и самые тёплые воспоминания.',
        cards: [
          {
            id: 'detstvo-dom',
            title: 'Мой дом',
      ...
      },
      {
        id: 'yunost',
        title: 'Юность',
        hint: 'Чувства, друзья, первые решения в своей жизни.',
        cards: [
          {
            id: 'yunost-druzya',
            title: 'Мои друзья',
      ...
      },
      {
        ...
        hint: 'Первые шаги в самостоятельную жизнь.',
        cards: [
          {
            id: 'vzr-bal',
            title: 'Выпускной',
      ...
      },
      {
        id: 'segodnya',
        title: 'Сегодня',
        hint: 'То, что наполняет жизнь сейчас.',
        cards: [
          {
            id: 'seg-uspeh',
